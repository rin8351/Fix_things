...
class Time_fix:
    def __init__(self):
        ...
        self.spisok_del = {j for i in self.time_zan for j in self.time_zan[i] if '_d' in j}
        self.zan = []
        self.week = ()
        ...
        self.week = (str(self.today - datetime.timedelta(days=i)) for i in range(7))
    ...
    def clear_plan(self):
        ...
        self.r2.create_image(135, 160, anchor=NW, image=self.image_dict['plan'])
    ...
    def plan(self):
        if self.zan == []:
            ...
            self.r2.create_image(135, 160, anchor=NW, image=self.image_dict['plan2'])
